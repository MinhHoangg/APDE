    ...
    <body align = "center" background="img/pic.png">
      ...
      <ul>
        ...
        if (isset($_POST['id'])) 
        {
          ...
          if ($_POST['id'] !="" && $_POST['name'] !="" && $_POST['topicName'] !="" && $_POST['courseName'] != "" && $_POST['trainerName'] != "") {
            $id = $_POST['id'];
            $name = $_POST['name'];
            ...
            $sql = "INSERT INTO trainee VALUES ('$id', '$name', '$topicName', '$courseName', '$trainerName')";
            $row = mysqli_query($conn, $sql);
          }
        }
        ?>
        <form class="w3-container" name="Insert" action="assign.php" method="POST">
          <p>
            <label>ID: </label>
