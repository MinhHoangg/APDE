      ...
      <ul>
        ...
        if (isset($_POST['id'])) 
        {
          ...
          if ($_POST['id'] !="") {
            ...
            $sql = "DELETE FROM trainerlist WHERE id = '$id'";
            $row = mysqli_query($conn, $sql);
          }
        }
        ?>
        <form class="w3-container" name="Insert" action="deleteTrainer.php" method="POST">
          <p>
            <label>ID: </label>
        ...
        <table align="center" id="customers">
          <tr><th align='center' width='200'>ID</th><th align='center' width='200'>Trainer Name</th></tr>
        </table>
        <?php
        $servername = "localhost";
        $username = "root";
